...
namespace Nop.Plugin.Misc.FortNox.Data
{
    ...
    /// </summary>
    public class FortNoxCustomerContext : DbContext, IDbContext
    {
        #region Ctor

        public FortNoxCustomerContext(DbContextOptions<FortNoxCustomerContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new FortNoxCustomerRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(FortNoxCustomerRecord));
        }
